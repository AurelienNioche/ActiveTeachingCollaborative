...
from simulate.simulate_human_like \
    import simulate_human_like_using_leitner as simulate
from plot.plot_hist_loss import plot_loss
from plot.plot_posterior import plot_posterior

RUN_NAME = "artificial_human_like_7_session_200_item"
